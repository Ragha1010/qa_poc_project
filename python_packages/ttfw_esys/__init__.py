...
from .ESYSApp import ESYSApp, SiApp, LoadableElfTestApp, UT, TestApp  # noqa: export all Apps for users
from .ESYSDUT import ESYSDUT, ESP32DUT, ESP32S2DUT, ESP8266DUT, ESP32QEMUDUT  # noqa: export DUTs for users
...
def idf_example_test(app=SiApp, dut=ESYSDUT, chip="ESP32", module="examples", execution_time=1,
...
def idf_unit_test(app=UT, dut=ESYSDUT, chip="ESP32", module="unit-test", execution_time=1,
...
def idf_custom_test(app=TestApp, dut=ESYSDUT, chip="ESP32", module="misc", execution_time=1,
